...
module.exports = {
	...
	chainWebpack: config => {
		...
		const ckeditor5EnvPattern = /[/\\]packages[/\\]ckeditor5[/\\]/;
		const ckeditor5CollaborationEnvPattern = /[/\\]packages[/\\]collaboration[/\\]/;

		svgRule.exclude.add( ckeditor5EnvPattern );
		svgRule.exclude.add( ckeditor5CollaborationEnvPattern );
	}
};
